...
const shapeVariants = {
  rectangle: { borderRadius: "24% 76%  / 92% 68% 68%", rotate: 0 },
...
const MorphingCard = ({
  ...
  return (
    <div className="relative" style={{ width, height }}>
      <motion.div
        className="absolute inset-0 cursor-pointer overflow-hidden rounded-2xl shadow-lg opacity-95 bg-gradient-to-r from-blue-300 to-blue-800"
      ...
      {/* <button
        className={`absolute bottom-4 right-4 rounded-full  p-2 text-white ${
          theme !== "dark"
            ? " bg-gray-800 hover:bg-gray-500"
            : " bg-white/20 hover:bg-white/30"
        }`}
