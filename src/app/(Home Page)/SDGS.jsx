  ...
  return (
    <section className="w-full bg-white py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-center text-3xl md:text-5xl font-bold mb-12 text-blue-800">
          <span className="text-blue-500">WFCCES 2025</span> IS DEDICATED TO ADVANCING THE
