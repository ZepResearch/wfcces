...
export const metadata = {
  title: "Registration | World Forum on Climate Change and Environmental Sustainability",
  ...
  openGraph: {
    title: "Registration WFCCES - Global Climate Change & Sustainability Forum",
  ...
  alternates: {
    canonical: "https://www.wfcces.com/registration",
  },
  robots: {
    index: true,
    follow: true,
